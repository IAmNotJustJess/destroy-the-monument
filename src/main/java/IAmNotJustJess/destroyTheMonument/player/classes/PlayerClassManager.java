...
public class PlayerClassManager {
    ...
    public static void cacheDescriptions() {
        ConsoleDebugSending.send("send-load-messages", "<#dbd814>Caching upgrade descriptions!");
        for(PlayerClass playerClass : list) {
            ...
            ConsoleDebugSending.send("send-load-messages", "<#14db4c>Successfully cached "+ playerClass.name +" upgrades!");
        }
    }
